...
\section{\textit{Web Mining}}
		...
		É importante ressaltar que Web Mining é diferente de Recuperação da Informação(\textit{Information Retrieval}) e Extração da Informação(\textit{Information Extraction}). 
