...
\section{Criação do Parser}
	...
	A ferramenta para a implementação do NameParser foi o JavaCC(Java Compiler Compiler[tm]). É um gerador de parser inicialmente desenvolvido pela Sun. Utiliza uma sintaxe próxima do Java, e trabalha \textit{top-down}.
	...
	A criação do Parser para a extração de nomes em paginas, foi desenvolvida em várias etapas. No primeiro momento, foi criado a Expressão Regular para a extração de nomes. 
