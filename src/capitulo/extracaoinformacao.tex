...
\section{Critérios de Avaliação} 
		...
		Para exemplificar os calculos de precisão e cobertura, vamos ilustrar um exemplo utilizando a pagina \textit{Association Alzheimer(http://www.alz.org/)} como nossa fonte de dados, a ferramenta extratora e o seu funcionamento serão discutidas adiante no capítulo ~\ref{Capitulo 5}. 
