...
\section{Avaliação}\label{EI:avaliacao} 
		...
		\begin{itemize}
              ...
              C = \frac{N_{extraido-correto}}{N_{total-extraidos}}              
            \end{equation}            
              ...
              P = \frac{N_{extraido-correto}}{N_{resposta}}
            \end{equation}
						
			Importante ressaltar que $N_{total-extraido}$ e $N_{resposta}$ são inversamente proporcionais, isto é, quando a cobertura aumenta, a precisão tende a diminuir e vice-cersa.
