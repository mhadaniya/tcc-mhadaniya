...
\section{Critérios de Avaliação} 
    ...
    is the number of true positives: the number of queries correctly classified into their true class.
        ...
        Interpretando os dados, nossa precisão é altíssima conseguindo obter todos os nomes presentes na página, porém extraimos muitas outras informações a mais. Aplicando a $F_1$, temos um aproveitamento de 31\%, ainda muito longe do ideal esperado.
