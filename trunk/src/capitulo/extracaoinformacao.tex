...
\section{Conceitos Básicos}\label{EI:conceitos}
	...
	\subsection{Tipos de texto}\label{EI:tipo_texto}
		...
		\begin{itemize}
          ...
          O pesquisador Sergel Abiteboul diferencia dentro do contexto de semi-estruturados, em cinco categorias\cite{Abiteboul1997}:
          \begin{itemize}
