...
\chapter{Caso de Uso - Projeto Salus Cyted}\label{Capitulo 5}
		...
		\begin{table}[htbp]
		  \centering   
		    ...
		    \bottomrule
		    \end{tabular}
			\caption{tab:regrasenomes}
		  \label{tab:Regras e exemplos de nomes}
		\end{table}
